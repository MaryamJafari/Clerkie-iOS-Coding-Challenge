...
class Bar: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        updateLabels()
        rates = [Rate(date: "Jan", base: "kj", rates: ["USD": 4.1, "USD2" : 3.2, "EUR" : 7.3, "GBP": 6.4 , "CHF" : 2.0, "CAD" : 3.6]) ,Rate(date: "Feb", base: "kj", rates: ["USD": 2.1, "USD2" : 1.2, "EUR" : 0.3, "GBP": 4.4 , "CHF" : 1.0, "CAD" : 5.6]) ,Rate(date: "March", base: "kj", rates: ["USD": 0.1, "USD2" : 7.2, "EUR" : 2.3, "GBP": 3.4 , "CHF" : 4.0, "CAD" : 3.6]),
        ]
    }
    ...
    func configureGraph() {
        ...
        let title = "Compare Expences Rates"
        graph.title = title
